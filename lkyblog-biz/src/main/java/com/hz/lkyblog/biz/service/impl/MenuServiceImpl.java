...
public class MenuServiceImpl implements MenuService {
    ...
    @Override
    public WebResult<List<MenuVo>> getMenus(Long roleId) {
        try {
            BlogRoleMenu menus = blogRoleMenuWrapper.getBy(BlogRoleMenuQuery.builder().roleId(roleId).build());
            ...
            log.error("getMenus error roleId:{},e:{}", roleId, e);
